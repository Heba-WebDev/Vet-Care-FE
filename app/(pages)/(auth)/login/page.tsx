...
export default function Signup() {
  return (
    <main className="h-screen md:grid md:grid-cols-2 screen-h">
      <section className="relative text-white hidden md:flex flex-col md:items-center md:justify-center bg-gradient-to-b from-[#0575E6] via-[#02298A]  to-[#021B79]">
